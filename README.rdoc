...
For now it is two-methods-gem, I use a lot.
...
I)
  def your_any_method any_args
    inspect!(local_variables,binding) # this string exactly!    
    ...
  end

Gives simple but nice trace of method's name and local_variables (if the #inspect! on the first line - local_variables = args passed to method)
